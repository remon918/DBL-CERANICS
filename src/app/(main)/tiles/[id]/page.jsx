...
const TilesDetailsPage = async ({ params }) => {
  ...
  return (
    <div className="md:w-[70%] w-[92%] mx-auto">
      <Link
        href="/alltiles"
        className="inline-flex mt-6 items-center gap-2 text-sm font-semibold text-gray-700 hover:text-gray-900 hover:shadow-sm"
      >
        <FaArrowLeft />
        Select More Tiles
      </Link>
      ...
      <div className="md:max-w-5xl max-w-3xl flex items-center justify-center bg-gray-100 mt-10">
        <div className="bg-white p-6 rounded-md shadow gap-4 grid grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <br /> <br />
            <button className="btn bg-pink-600  hover:bg-pink-500 text-white">
              {inStock ? "Place Order" : "Available in Pre Order"}
            </button>
          </div>
        </div>
      </div>
